...
router.post('/:id/capture/', async function handleRequest(req, res) {
  ...
  const output= `
  <p> Thank you for buying the VisittUs membership. We are delighted to have you on board. </p>
  ...
  <tr> <td> Items Purchased</td><td> VisittUs Membership </td></tr>
  </table>
  ...
  This is intended for verification purposes for whenever you visit one of our partner brands.</p></font>
  <br>
  Regards
  <br>
  Team VisittUs
  <img  src="cid:iam" style="width:550px;height:200px">
  `
...
let info = transporter.sendMail({
  from: '"VisittUs" <contact@adityagarwal.co>', // sender address
  to: `thats.adi.007@Gmail.com, ${capture.result.payer.email_address}`, // list of receivers
  subject: "Order Confirmation: Visitt.Us Membership", // Subject line
  text: "", // plain text body
  html: output, // html body
  attachments: [{
          filename: 'visitt.png',
          path: __dirname +'/../public/visitt.png',
          cid: 'iam'
      }],
});
console.log(info)
